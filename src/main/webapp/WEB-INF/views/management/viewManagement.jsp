...
.graph_1  { width: 375px; list-style: none;margin: 0; padding: 0; float : left; clear: both; }
...
.graph_2  { width: 375px; list-style: none;margin: 0; padding: 0; float : left; clear: both;     margin-bottom: 50px;}
